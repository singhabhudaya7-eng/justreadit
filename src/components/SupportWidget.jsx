  ...
  return (
    <>
      <div className="support-widget">
        <button className="support-link" title="Why this site exists" onClick={() => setShowModal(true)}>
          <svg className="support-cup" viewBox="0 0 36 36" width="15" height="15" aria-hidden="true">
      ...
      {showModal && (
        <div className="support-modal-overlay" onClick={() => setShowModal(false)}>
          <div className="support-modal" onClick={e => e.stopPropagation()}>
            <button className="support-modal-close" onClick={() => setShowModal(false)}><X size={14} /></button>
            <div className="support-modal-icon"><Heart size={26} strokeWidth={1.5} /></div>
            <p className="support-modal-text">
              Hey reader — I crafted this site with a lot of love, for you to read as you please.
            </p>
            <p className="support-modal-text">
              If you like my work, feel free to browse my small business.
            </p>
            <a
